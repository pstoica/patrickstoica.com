...
<script>
	...
	posthog.init('phc_GlHVllLBZzjEPfxsTf1U2WzjRSrJBXVkOjqSH37bnf1',{api_host:'https://ph.patrickstoica.com'})
</script>
</svelte:head>
...
<div class="layout">
	...
	<main class="prose prose-invert lg:prose-l max-w-none px-4">
		<slot />
	</main>
</div>
